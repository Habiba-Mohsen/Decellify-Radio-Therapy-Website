...
Here are some screenshots showcasing the user interface of the Decellify Radiotherapy Information System:

### Dashboard

![Dashboard](https://github.com/Habiba-Mohsen/Decellify-Radio-Therapy-Website/blob/main/assets/UI.png)

### Patients Management 
![Patients](https://github.com/Habiba-Mohsen/Decellify-Radio-Therapy-Website/blob/main/assets/UI-3.png)

> 📁 *Note:* All screenshots are located in the `/assets` directory of the project. Make sure this directory is included in your repo.
...
<table>
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/ZiadMeligy" target="_blank">
    ...
    <td align="center">
      <a href="https://github.com/MariamHany01" target="_blank">
      <img src="https://github.com/MariamHany01.png" width="150px;" alt="Mariam Hany"/>
      <br />
      <sub><b>Mariam Hany</b></sub></a>
    </td>
    <td align="center">
      <a href="https://github.com/hanaheshamm" target="_blank">
      <img src="https://github.com/hanaheshamm.png" width="150px;" alt="Hana Hesham"/>
      <br />
